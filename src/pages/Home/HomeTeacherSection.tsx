...
const HomeTeacherSection = (props: any) => {
    ...
    const GetData = props?.data?.teacherData
        ...
        fetch(API_ENDPOINTS.UPDATEHOMEDATA, requestOptions)
            ...
            .then(result => {
                if (result.status == 200) {
                    showMessage('Teacher section updated successfully')
                } else {
    ...
    return (
        <div className="panel">
            <div className="mb-5">
                <h5 className="block dark:text-white font-bold text-xl mb-1">Teachers Section</h5>
            </div>
            <div className="mb-5">
                    ...
                    <div className="text-[#515365] dark:text-white-light font-semibold  flex justify-center">
                        <div className="md:w-5/6">
                            <div className="mb-4">
                                ...
                                <TextInput type='text' label='' Placeholder='Enter Title'
                                    value={studTitle}
                                    onChange={(e) => setStudTitle(e.target.value)}
                                />
                                ...
                                <TextInput
                                    ...
                                    value={studButtonLink}
                                    onChange={(e) => setStudButtonLink(e.target.value)}
...
export default HomeTeacherSection