...
const HomeStudentSection = (props: any) => {
    ...
    const GetData = props?.data?.studentData;
    useEffect(() => {
        ...
        fetch(API_ENDPOINTS.UPDATEHOMEDATA, requestOptions)
            ...
            .then((result) => {
                if (result.status == 200) {
                    showMessage('Student section updated successfully');
                } else {
    ...
    return (
        <div className="panel">
            <div className="mb-5">
                <h5 className="block dark:text-white font-bold text-xl mb-1">Student Section</h5>
            </div>
            <div className="mb-5">
