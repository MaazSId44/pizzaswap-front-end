...
const ContactUs = () => {
    ...
    const handleSubmit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        } else if (description.trim() == '' || description === '<p><br></p>') {
        ...
        setLoading(true);
        // Handle form submission logic here, including sending data to API
        const apiUrl = API_ENDPOINTS.UPDATECONTACT;
        const headers = {
    ...
    const getContact = () => {
        setLoading(true);
        const apiUrl = API_ENDPOINTS.GETCONTACT;
        const headers = {
            Authorization: 'Bearer ' + token,
        };
        const formData = new FormData();
    ...
    return (
        <div>
            {loading && <Loader />}
            <h1 className="text-4xl font-bold mb-6 ms-5">Contact Us</h1>
            ...
            <div className="grid grid-cols-6">
                <div className="col-span-8 md:col-span-4 lg:col-span-4 xl:col-span-4 px-6 py-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="description" className="block text-gray-700 dark:text-white font-bold text-xl  mb-1">
                                Description
                            </label>
                        ...
                        <div>
                            <label htmlFor="image" className="block dark:text-white font-bold text-xl mb-1">
                                Image
                            </label>
