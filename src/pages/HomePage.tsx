...
const HomePage = () => {
    ...
    return (
        <div>
            <div className="pt-5">
                <div className="my-5 text-center text-2xl font-bold dark:text-white md:text-5xl">Home Page</div>

                <div className="grid pt-5 grid-cols-4 md:grid-cols-4  mx gap-5">
                    <div className="panel col-span-3">
                        <div className="mb-5">
                            <h5 className="font-semibold text-lg dark:text-white-light">Banner section</h5>
                        </div>
                        <div className="mb-5">
                                ...
                                <div className="md:w-5/6">
                                    ...
                                    <div className="md:flex gap-5">
                                        <div className="mb-4 w-full">
                                            <TextInput onChange={(e: any) => setBtnText(e.target.value)} type="text" value={btnText} label="First button text" Placeholder="Enter text" />
                                        </div>
                                        <div className="mb-4 w-full">
                                            <TextInput onChange={(e: any) => setBtnLink(e.target.value)} type="text" value={btnLink} label="First button link" Placeholder="Enter link" />
                                        </div>
                                    </div>
                                    <div className="md:flex gap-5">
                                        <div className="mb-4 w-full">
                                            <TextInput onChange={(e: any) => setBtnText2(e.target.value)} type="text" value={btnText2} label="Second button text" Placeholder="Enter text" />
                                        </div>
                                        <div className="mb-4 w-full">
                                            <TextInput onChange={(e: any) => setBtnLink2(e.target.value)} type="text" value={btnLink2} label="Second button link" Placeholder="Enter link" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        <div className="xl:flex items-center gap-3 ">
                                            <div className="w-full">
                                                <label className="block dark:text-white font-bold text-xl mb-1 w-48">Change left Image</label>
                                            ...
                                            <div className=" mt-5 xl:mt-0 w-full">
                                                <label className="xl:w-fit dark:text-white font-bold text-xl mb-1 w-48">Change right image</label>
